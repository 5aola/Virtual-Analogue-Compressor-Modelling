...
# Add parent directory to sys.path to access B_analysis modules
sys.path.insert(0, os.path.abspath(os.path.join(os.path.dirname(__file__), "..")))

from B_analysis.utils import load_audio, calc_gain_reduction
...
def main():
    ...
    parser.add_argument("--output-dir", default="eval_output/dataset_gr_eval", help="Output directory for CSV and plots")
