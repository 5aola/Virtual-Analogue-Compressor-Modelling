...
Usage
-----
    uv run python eval_all_settings.py \
        --ckpt "nablafx-diffssl/experiments/TCN_L_TF/dafx/brqmbvok/checkpoints/last.ckpt" \
        --device mps

    nablafx-diffssl/experiments/S4_L_TF/dafx/h8sxc679/checkpoints/last.ckpt
    nablafx-diffssl/experiments/TCN_L_TF/dafx/brqmbvok/checkpoints/last.ckpt
"""
...
def main():
    ...
    parser.add_argument("--output_dir", default="eval_output/all_settings")
