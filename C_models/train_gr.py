...
Usage:
    python C_models/train_gr.py                          # defaults
    python C_models/train_gr.py --max_epochs 200         # override
    python C_models/train_gr.py --data_root /path/to/data --batch_size 8
"""
...
def main() -> None:
    ...
    trainer = pl.Trainer(
        ...
        default_root_dir="C_models/lightning_logs",
    )
