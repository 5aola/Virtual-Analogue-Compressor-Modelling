"""
Experimental comparison of Hilbert envelope vs RMS-window gain reduction
and reconstruction quality.

Scratch script — not part of the evaluation pipeline.
"""
...
# ---------------------------------------------------------------------------
# Data loading — pick ONE of these blocks
# ---------------------------------------------------------------------------
...
# ---------------------------------------------------------------------------
# Gain reduction: Hilbert vs RMS at different window sizes
# ---------------------------------------------------------------------------
...
s_hilbert = torch.as_tensor(
    recreated_sig_hilbert, dtype=torch.float32
).unsqueeze(0).unsqueeze(0)

results = [("Hilbert Envelope", loss.compute_all_losses(s_hilbert, s_wet))]
